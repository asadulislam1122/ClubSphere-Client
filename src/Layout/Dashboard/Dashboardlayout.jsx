...
const Dashboardlayout = () => {
  ...
  const linkStyle = ({ isActive }) =>
    isActive
      ? "text-primary font-semibold" // ক্লিক করলে সবুজ হবে
      : "hover:text-primary transition"; // সাধারণ অবস্থায় এবং হোভারে
        ...
        <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
          <ul className="menu w-full grow">
            ...
            <li>
              ...
              >
                <img
                  ...
                  alt="Logo"
                />
                <span className="is-drawer-close:hidden text-primary font-semibold">
                  ClubSphere
                </span>
              </NavLink>
            </li>
            ...
            {role === "manager" && (
              <>
                <li>
                  <NavLink to={"/dashboard/club"} className={linkStyle}>
                    <IoIosCreate />
                    <span className="is-drawer-close:hidden">Create Club</span>
                  </NavLink>
                </li>
                <li>
                  <NavLink to={"/dashboard/my-club"} className={linkStyle}>
                    <FaCcDinersClub />
                    <span className="is-drawer-close:hidden">My Clubs</span>
                  </NavLink>
                </li>
                <li>
                  <NavLink to={"/dashboard/add-event"} className={linkStyle}>
                    <MdEventAvailable />
                    <span className="is-drawer-close:hidden">Add Event</span>
                  </NavLink>
                </li>
            ...
            {role === "admin" && (
              <>
                <li>
                  <NavLink to={"/dashboard/all-payments"} className={linkStyle}>
                    <FaDollarSign />
                    <span className="is-drawer-close:hidden">
                      Admin Overview
                    </span>
